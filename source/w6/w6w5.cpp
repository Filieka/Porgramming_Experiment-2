...
public:
    Rectangle(Segment *a):Shape(a,4){}
    float getArea(){
        return 0.5*abs(getSeg(0).getPoint1().getX()*getSeg(0).getPoint2().getY()+getSeg(0).getPoint2().getX()*getSeg(2).getPoint1().getY()+getSeg(2).getPoint1().getX()*getSeg(2).getPoint2().getY()+getSeg(2).getPoint2().getX()*getSeg(0).getPoint1().getY()-getSeg(0).getPoint2().getX()*getSeg(0).getPoint1().getY()-getSeg(2).getPoint1().getX()*getSeg(0).getPoint2().getY()-getSeg(2).getPoint2().getX()*getSeg(2).getPoint1().getY()-getSeg(0).getPoint1().getX()*getSeg(2).getPoint2().getY());
    }
    /*
    x1   x2   x3   x4    x1
       X    X    X    X
